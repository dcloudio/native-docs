...
Currently, the sharing function supports Sina Weibo sharing, QQ sharing, and WeChat sharing. The sharing function first needs to apply for an account on each open platform. Refer to [Documentation](http://ask.dcloud.net.cn/article/36)
...
**注意 :所有分享都需要实现如下方法**
**Note: All sharing needs to implement the following methods**
